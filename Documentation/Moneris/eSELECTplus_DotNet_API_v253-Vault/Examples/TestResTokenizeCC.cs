namespace Moneris
{
	...
	public class TestResTokenizeCC
	{
	  public static void Main(string[] args)
	  {
        ...
        string order_id = "original_order_id";
        string txn_number = "original_txn_number";
        ...
        HttpsPostRequest mpgReq = new HttpsPostRequest(host, store_id, api_token, resTokenizeCC);
