...
{
	[Activity (Label = "FacebookWebViewAuthActivity")]			
	public class FacebookWebViewAuthActivity: Activity
    {
		FacebookClient fb;
		string url;
		string appId;
		...
		{ 
			FacebookWebViewAuthActivity parentActivity;

			public FBWebClient (FacebookWebViewAuthActivity parentActivity)
			{
