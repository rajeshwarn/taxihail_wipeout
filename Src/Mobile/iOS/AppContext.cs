	...
	public class AppContext : IAppContext
	{
		...
		public void UpdateLoggedInUser (AccountData data, bool syncWithServer)
		{
			...
			if (data != null)
			{
				...
				NSUserDefaults.StandardUserDefaults.SetSerializedObject<AccountData> (
					data,
					"TaxiMobile.AccountData.CurrentUser"
				);
		...
		public AccountData LoggedUser {
			get {
				...
				if (_loggedUser == null)
				{
					...
					if ((_loggedUser != null) && (_loggedUser.DefaultSettings != null) && (_loggedUser.DefaultSettings.Company != 12))
					{						
		...
		public string LastEmailUsed {
			...
			set { NSUserDefaults.StandardUserDefaults.SetStringOrClear (
					value,
