...
namespace TaxiMobileApp
{
	public partial class BookTabView : UIViewController, ITaxiViewController, ISelectableViewController, IRefreshableViewController
	{
		...
		public override void ViewDidAppear (bool animated)
		{
			...
			if ((AppContext.Current.LastOrder.HasValue) && (AppContext.Current.LoggedUser != null) && (AppContext.Current.LoggedUser.BookingHistory != null) && (AppContext.Current.LoggedUser.BookingHistory.Any (o => o.Id == AppContext.Current.LastOrder.Value)))
			{
...
//		}
		...
		private void LoadStatusView (BookingInfoData order, bool closeScreenWhenCompleted)
		{
			...
			{
				InvokeOnMainThread (() => {
					_statusView.View.Hidden = false; });
				InvokeOnMainThread (() => {
					_statusView.Refresh (order, closeScreenWhenCompleted); });
			}
		}
