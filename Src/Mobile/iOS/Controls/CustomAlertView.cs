...
namespace apcurium.MK.Booking.Mobile.Client.Controls
{
    public class CustomAlertView: UIView
    {
            ...
            Action positiveAction, string negativeButtonTitle, Action negativeAction, string neutralButtonTitle, Action neutralAction)
        {
            ...
            InitDialogView();
            InitTripleButtons(negativeButtonTitle, positiveButtonTitle, neutralButtonTitle, negativeAction, positiveAction, neutralAction);
        }
        ...
        private void InitPrompt(Action cancelAction, bool isNumericOnly = false, string inputText = "")
        {
            ...
            _dialogView.AddConstraint(
                NSLayoutConstraint.Create(CustomInputView, NSLayoutAttribute.Top, NSLayoutRelation.Equal, !_message.HasValue() ? lblTitle : _messageView, NSLayoutAttribute.Bottom, 1f, _globalMargin));
        ...
        private void InitTripleButtons(string negativeTitle, string positiveTitle, string neutralTitle, Action negativeAction, Action positiveAction, Action thirdAction)
        {
