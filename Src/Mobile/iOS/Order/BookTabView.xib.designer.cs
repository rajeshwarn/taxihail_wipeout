...
namespace apcurium.MK.Booking.Mobile.Client {
	...
	[MonoTouch.Foundation.Register("BookTabView")]
	public partial class BookTabView {
		...
		private MonoTouch.UIKit.UIView __mt_viewDest;
		
		private MonoTouch.UIKit.UIView __mt_viewPick;
		...
		[MonoTouch.Foundation.Connect("viewDest")]
		private MonoTouch.UIKit.UIView viewDest {
			get {
				this.__mt_viewDest = ((MonoTouch.UIKit.UIView)(this.GetNativeField("viewDest")));
				return this.__mt_viewDest;
			}
			set {
				this.__mt_viewDest = value;
				this.SetNativeField("viewDest", value);
			}
		}
		
		[MonoTouch.Foundation.Connect("viewPick")]
		private MonoTouch.UIKit.UIView viewPick {
			get {
				this.__mt_viewPick = ((MonoTouch.UIKit.UIView)(this.GetNativeField("viewPick")));
				return this.__mt_viewPick;
			}
			set {
				this.__mt_viewPick = value;
				this.SetNativeField("viewPick", value);
			}
		}
	}
}
