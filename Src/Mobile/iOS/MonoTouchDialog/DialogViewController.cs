...
namespace MonoTouch.Dialog
{
    public class DialogViewController : UITableViewController
    {
        ...
        {
            return apcurium.MK.Booking.Mobile.Client.Resources.DefaultRideSettingsViewTitle;
        }
        ...
        public class Source : UITableViewSource
        {
            ...
            public override UITableViewCell GetCell(UITableView tableView, MonoTouch.Foundation.NSIndexPath indexPath)
            {
                ...
                cell.BackgroundColor = Container.GetCellColor();
...
//              //section.HeaderView.BackgroundColor = UIColor.Clear;
...
//              return section.HeaderView;
                ...
                headerLabel.HighlightedTextColor = UIColor.DarkGray;
                headerLabel.Font = UIFont.BoldSystemFontOfSize(16);             
                headerLabel.Text = section.Caption;
...
//              return section.HeaderView.Frame.Height;
            ...
            {
                //var section = Root.Sections [sectionIdx];
                //section.FooterView.BackgroundColor = UIColor.Clear;
                return new UIView(){ BackgroundColor = UIColor.Clear};
        ...
        public override void LoadView()
        {
            ...
            tableView.Frame = new RectangleF(UIScreen.MainScreen.Bounds.X, UIScreen.MainScreen.Bounds.Y + 50, UIScreen.MainScreen.Bounds.Width, UIScreen.MainScreen.Bounds.Height);         
            tableView.ContentSize = new SizeF(UIScreen.MainScreen.Bounds.Width, UIScreen.MainScreen.Bounds.Height + 200);
            View = tableView;
        ...
        protected virtual void SetTitleView()
        {
            
            if (this.NavigationItem != null)
            {               
                NavigationItem.TitleView = apcurium.MK.Booking.Mobile.Client.AppContext.Current.Controller.GetTitleView(null, GetTitle()); 
            }
        }
