...
public final class DemoDetailsList {
    ...
    public static final DemoDetails[] DEMOS = {
        ...
        new DemoDetails(R.string.maps_engine_demo_label,
                        R.string.maps_engine_demo_description,
                        MapsEngineDemoActivity.class),
        new DemoDetails(R.string.maps_engine_o_auth_demo_label,
                        R.string.maps_engine_o_auth_demo_description,
                        MapsEngineOAuthDemoActivity.class),
