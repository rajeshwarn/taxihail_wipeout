...
using BraintreeEncryption.Library.BouncyCastle.Math;
using BraintreeEncryption.Library.BouncyCastle.Security;

namespace BraintreeEncryption.Library.BouncyCastle.Crypto.Engines
{
	/**
		...
		*/
			...
			BigInteger result)
		{
			...
			if (forEncryption)
			{
				...
				// TODO_ To avoid this, create version of BigInteger.ToByteArray that
