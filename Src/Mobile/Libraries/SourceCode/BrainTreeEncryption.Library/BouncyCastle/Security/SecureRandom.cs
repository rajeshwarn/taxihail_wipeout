...
using BraintreeEncryption.Library.BouncyCastle.Crypto.Digests;
using BraintreeEncryption.Library.BouncyCastle.Crypto.Prng;
...
namespace BraintreeEncryption.Library.BouncyCastle.Security
{
		...
		: Random
    {
		...
		public static SecureRandom GetInstance(
			string algorithm)
		{
			// TODO_ Compared to JDK, we don't auto-seed if the client forgets - problem?

			// TODO_ Support all digests more generally, by stripping PRNG and calling DigestUtilities?
