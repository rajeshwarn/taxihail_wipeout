...
namespace SocialNetworks.Services.OAuth
{
	public class WebViewController : UIViewController {
		...
		protected WebViewController ()
		{
			...
			backButton = new UIBarButtonItem (UIImage.FromFile ("Assets/back.png"), UIBarButtonItemStyle.Plain, (o, e) => { WebView.GoBack (); });
			forwardButton = new UIBarButtonItem (UIImage.FromFile ("Assets/forward.png"), UIBarButtonItemStyle.Plain, (o, e) => { WebView.GoForward (); });
