...
namespace apcurium.MK.Booking.Mobile.ViewModels
{
    public class UpdatePasswordViewModel : BaseViewModel
    {
		...
		public UpdatePasswordViewModel( IAccountService accountService, Guid accountId )
        {
        ...
        public IMvxCommand UpdateCommand
        {
            get
            {
                ...
                return new MvxRelayCommand(() => {
					...
					var response = _accountService.UpdatePassword( _accountId, CurrentPassword, NewPassword );
