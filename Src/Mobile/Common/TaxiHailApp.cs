...
namespace apcurium.MK.Booking.Mobile
{
    public class TaxiHailApp  : MvxApplication
    {
        ...
        private void InitalizeServices()
        {
			...
			return new PaymentService(baseUrl, sessionId, c.Resolve<ConfigurationClientService>(), c.Resolve<ICacheService>(), c.Resolve<IPackageInfo>(), c.Resolve<ILogger>(), c.Resolve<IConnectivityService>());
