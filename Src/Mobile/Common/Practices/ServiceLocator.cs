...
namespace Microsoft.Practices.ServiceLocation
{
	...
	public class ServiceLocator
	{
		...
		private Dictionary<Type, object> _registryFactory = new Dictionary<Type, object> ();
		...
		{
			_registryFactory.Add (typeof(TInterface), factory);   
		}
		...
		{			
			...
			if (_registryFactory.ContainsKey (typeof(T)))
			{
				var func = (Func<T>)_registryFactory[typeof(T)];
				var instance=  func();
				return instance;
			}
			else if (_registrySingleInstance.ContainsKey (typeof(T))) {
