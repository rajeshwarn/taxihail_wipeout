...
//		{
//			var f = new RectangleF(  bounds.X , bounds.Y  , bounds.Width , bounds.Height  );
//			var v = new UITableView (f, style);
//			
...
//		{
//			tableView = MakeTableView (new RectangleF( UIScreen.MainScreen.Bounds.X ,  UIScreen.MainScreen.Bounds.Y ,  UIScreen.MainScreen.Bounds.Width,  UIScreen.MainScreen.Bounds.Height *2), Style);
...
//			UpdateSource ();
//			
//			var rootView =new UIView(new RectangleF( UIScreen.MainScreen.Bounds.X ,  UIScreen.MainScreen.Bounds.Y ,  UIScreen.MainScreen.Bounds.Width,  UIScreen.MainScreen.Bounds.Height ) );
//			
//			var v = new UIScrollView ( new RectangleF( UIScreen.MainScreen.Bounds.X ,  UIScreen.MainScreen.Bounds.Y +50 ,  UIScreen.MainScreen.Bounds.Width,  UIScreen.MainScreen.Bounds.Height  - 120));
//			v.ContentSize = new SizeF( UIScreen.MainScreen.Bounds.Width , UIScreen.MainScreen.Bounds.Height  + 50 );
...
//		}
//		
//		public DialogViewController (RootElement root) : base ()
//		{
//			PrepareRoot (root);
//		}
//		
//		public DialogViewController (UITableViewStyle style, RootElement root) : base ()
//		{
//			PrepareRoot (root);
//		}
//		
...
//		/// </param>
//		public DialogViewController (RootElement root, bool pushing) : base ()
//		{
//			this.pushing = pushing;
//			PrepareRoot (root);
//		}
//
//		public DialogViewController (UITableViewStyle style, RootElement root, bool pushing) : base ()
//		{
//			this.pushing = pushing;
//			PrepareRoot (root);
//		}
