...
output\LocalizationTool.exe -t=android -m="..\Mobile\Common\Localization\Master.resx" -d="..\Mobile\MK.Callbox.Mobile.Client.Android\Resources\Values\Strings.xml" -s="..\Mobile\Common\Settings\Settings.json"
PAUSE