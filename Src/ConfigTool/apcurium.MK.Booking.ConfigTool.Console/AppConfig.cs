    ...
    public class AppConfig
    {
        ...
        private void Init()
        {
            _configs = new Config[]
           {
				    ...
				    new ConfigFile(this){ Source=@"CallBox\Logo@2x.png", Destination=@"Mobile\MK.Callbox.Mobile.Client.Android\Resources\Drawable-hdpi\Logo.png" },
				    ...
				    new ConfigFile(this){ Source=@"CallBox\icon@2x.png", Destination=@"Mobile\MK.Callbox.Mobile.Client.Android\Resources\Drawable-hdpi\icon.png" },
				    new ConfigFile(this){ Source=@"CallBox\navBar.png", Destination=@"Mobile\MK.Callbox.Mobile.Client.Android\Resources\Drawable\navBar.png" },
					new ConfigFile(this){ Source=@"CallBox\navBar@2x.png", Destination=@"Mobile\MK.Callbox.Mobile.Client.Android\Resources\Drawable-hdpi\navBar.png" },
