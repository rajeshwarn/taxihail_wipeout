    ...
    public class AppConfig
    {
        ...
        private void Init()
        {
            _configs = new Config[]
           {
					...
					new ConfigFile(this){ Source=@"CallBox\Logo.png", Destination=@"Mobile\MK.Callbox.Mobile.Client.Android\Resources\Drawable\Logo.png" },
				    new ConfigFile(this){ Source=@"CallBox\hdpi\Logo.png", Destination=@"Mobile\MK.Callbox.Mobile.Client.Android\Resources\Drawable-hdpi\Logo.png" },
					new ConfigFile(this){ Source=@"CallBox\icon.png", Destination=@"Mobile\MK.Callbox.Mobile.Client.Android\Resources\Drawable\icon.png" },
					new ConfigFile(this){ Source=@"CallBox\hdpi\icon.png", Destination=@"Mobile\MK.Callbox.Mobile.Client.Android\Resources\Drawable-hdpi\icon.png" },
				    new ConfigFile(this){ Source=@"CallBox\navBar.png", Destination=@"Mobile\MK.Callbox.Mobile.Client.Android\Resources\Drawable\navBar.png" },
					new ConfigFile(this){ Source=@"CallBox\hdpi\navBar.png", Destination=@"Mobile\MK.Callbox.Mobile.Client.Android\Resources\Drawable-hdpi\navBar.png" },
					...
					new ConfigXML(this){  Destination=@"Mobile\MK.Callbox.Mobile.Client.Android\Properties\AndroidManifest.xml", NodeSelector=@"//manifest/application", Attribute="android:label" , SetterAtt = ( app, att )=> att.Value = Config.AppName + " CallBox" },
	                ...
	                new ConfigXML(this){  Destination=@"Mobile\Android\Properties\AndroidManifest.xml", NodeSelector=@"//manifest/uses-permission[@android:name=""com.apcurium.MK.TaxiHailDemo.permission.C2D_MESSAGE""]", Attribute="android:name", SetterAtt = ( app, att )=> att.Value = Config.AppName + ".permission.C2D_MESSAGE" },
