...
namespace apcurium.MK.Booking.Api.Services.Payment
{
    public class PaymentService : Service
    {
        ...
        public PaymentService(ICommandBus commandBus, IConfigurationDao configurationDao, IBookingWebServiceClient bookingWebServiceClient, IPaymentServiceClient paymentClient)
        {
