...
namespace apcurium.MK.Booking.Api.Services
{
    public class CreateOrderService : Service
    {
        ...
        public object Post(CreateOrder request)
        {
            ...
            var accountValidationResult = ValidateChargeAccountIfNecessary(request, orderCommand.OrderId, account, isFutureBooking, market, isPrepaid);
        ...
        private ChargeAccountValidationResult ValidateChargeAccountIfNecessary(CreateOrder request, Guid orderId, AccountDetail account, bool isFutureBooking, string market, bool isPrepaid)
        {
            string[] prompts = null;
