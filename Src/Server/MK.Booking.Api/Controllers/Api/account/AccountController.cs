...
namespace apcurium.MK.Web.Controllers.Api.Account
{
    public class AccountController : BaseApiController
    {
        ...
        [HttpPut, Auth(Role = RoleName.Support), Route("api/accounts/update/{accountId}")]
        ...
        [HttpPut, Route("api/accounts/bookingsettings")]
        ...
        [HttpGet, Route("api/accounts/getconfirmationcode/{email}/{countryCode}/{phoneNumber}")]
        ...
        [HttpGet, Route("api/accounts/confirm/{emailAddress}/{confirmationToken}")]
        ...
        [HttpGet, Route("api/accounts/confirm/{emailAddress}/{confirmationToken}/{isSmsConfirmation}")]
        ...
        [HttpGet, Auth, NoCache, Route("api/accounts")]
        ...
        [HttpGet, NoCache, Route("api/accounts/phone/{email}")]
        ...
        [HttpPost, Route("api/accounts/register")]
        ...
        [HttpPost, Route("api/accounts/resetpassword/{emailAddress}")]
        ...
        [HttpPost, Auth, Route("api/accounts/{accountId}/updatePassword")]
