var UpdateServiceType = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "﻿<div class='well'>\r\n    <h4 class=\"table-title\">"
    ...
    + escapeExpression(((helpers.localize || (depth0 && depth0.localize) || helperMissing).call(depth0, "Future Booking Threshold (Minutes)", {"name":"localize","hash":{},"data":data})))
    + "</label>\r\n            <div class=\"controls\">\r\n                <input type=\"number\" id=\"inputFutureBookingThresholdInMinutes\" name=\"futureBookingThresholdInMinutes\" value=\""
    + escapeExpression(((helper = (helper = helpers.futureBookingThresholdInMinutes || (depth0 != null ? depth0.futureBookingThresholdInMinutes : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"futureBookingThresholdInMinutes","hash":{},"data":data}) : helper)))
