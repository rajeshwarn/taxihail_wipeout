...
public partial class WebOrder7Service : System.Web.Services.Protocols.SoapHttpClientProtocol
{
    ...
    public void SaveExtrPayment_2Async(
                ...
                string UserAgent)
    {
        this.SaveExtrPayment_2Async(Login, Password, OrderID, TransID, AuthNum, CardToken, PaymentType, PaymentProvider, MDTTip, MDTToll, MDTExtras, MDTFare, PaymentTipAmount, PaymentMeterAmount, PaymentTotal, AccountID, Name, Phone, Email, OS, UserAgent, null);
    }
                ...
                object userState)
    {
        ...
        this.InvokeAsync("SaveExtrPayment_2", new object[] {
                    ...
                    Email,
                    OS,
                    UserAgent}, this.SaveExtrPayment_2OperationCompleted, userState);
    }
