...
public partial class WebOrder7Service : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    [return: System.Xml.Serialization.SoapElementAttribute("ATotalFare")]
    public double EstimateFare_8(string Login, string Password, TBookOrder_8 ABookOrder, out double AFare, out double ATolls, out double ADistance) {
    ...
    /// <remarks/>
    public double EndEstimateFare_8(System.IAsyncResult asyncResult, out double AFare, out double ATolls, out double ADistance) {
        object[] results = this.EndInvoke(asyncResult);
        AFare = ((double)(results[1]));
        ATolls = ((double)(results[2]));
        ADistance = ((double)(results[3]));
