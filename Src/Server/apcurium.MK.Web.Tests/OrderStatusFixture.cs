...
namespace apcurium.MK.Web.Tests
{
    ...
    public class OrderStatusFixture : BaseTest
    {
        ...
        public override void TestFixtureSetup()
        {
            ...
            var authResponseTask = new AuthServiceClient(BaseUrl, null, new PackageInfo()).Authenticate(TestAccount.Email, TestAccountPassword);
            authResponseTask.Wait();
            var authResponse = authResponseTask.Result;

            _orderId = Guid.NewGuid();
            var sut = new OrderServiceClient(BaseUrl, authResponse.SessionId, new PackageInfo());
