...
namespace apcurium.MK.Booking.Helpers
{
    public class OrderBailedCreationHelper
    {
        ...
        public OrderBailedCreationHelper(ICommandBus commandBus, IServerSettings serverSettings, ILogger logger)
        {
        ...
        public bool SendOrderCreationCommands(Guid orderId, int? ibsOrderId, bool dispatcherTimedOut, string newCompanyKey, string clientLanguageCode)
        {
