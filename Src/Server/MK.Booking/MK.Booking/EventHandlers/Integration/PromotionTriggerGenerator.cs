                ...
                foreach (var promotion in promotions)
                {
                    ...
                    else if (promotion.TriggerSettings.Type == PromotionTriggerTypes.AmountSpent)
                    {
                        ...
                        var totalAmountSpent = eligibleOrders.Any(x => x.Id == orderId)
                            ? eligibleOrders.Sum(x => x.Fare.GetValueOrDefault() + x.Tax.GetValueOrDefault() + x.Toll.GetValueOrDefault() + x.Surcharge.GetValueOrDefault() + x.Extra.GetValueOrDefault())
                            : eligibleOrders.Sum(x => x.Fare.GetValueOrDefault() + x.Tax.GetValueOrDefault() + x.Toll.GetValueOrDefault() + x.Surcharge.GetValueOrDefault() + x.Extra.GetValueOrDefault()) + value;
