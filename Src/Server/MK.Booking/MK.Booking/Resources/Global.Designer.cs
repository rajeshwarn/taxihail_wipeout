...
namespace apcurium.MK.Booking.Resources {
    ...
    public class Global {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Thank you for using Mears. If you were happy with your service and would like to apply an additional gratuity for your driver, please do so in the app..
        /// </summary>
        public static string PushNotification_InfoAboutGratuity {
            get {
                return ResourceManager.GetString("PushNotification_InfoAboutGratuity", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Your vehicle has been waiting for ten minutes.  Please contact the driver if you would like your vehicle to wait longer..
        /// </summary>
        public static string PushNotification_NoShowWarning {
            get {
                return ResourceManager.GetString("PushNotification_NoShowWarning", resourceCulture);
            }
        }
