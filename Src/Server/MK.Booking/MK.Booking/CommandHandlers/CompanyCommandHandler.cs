...
namespace apcurium.MK.Booking.CommandHandlers
{
        ...
        ICommandHandler<UpdatePrivacyPolicy>
    {
        ...
        public void Handle(AddUpdateVehicleType command)
        {
            ...
            company.AddUpdateVehicleType(command.VehicleTypeId, command.Name, command.LogoName, command.ReferenceDataVehicleId, command.MaxNumberPassengers, command.NetworkVehicleTypeId);
