...
namespace apcurium.MK.Booking.CommandHandlers
{
        ...
        ICommandHandler<SettleOverduePayment>
    {
        ...
        public void Handle(ReactToPaymentFailure command)
        {
            ...
            account.ReactToPaymentFailure(command.OrderId, command.IBSOrderId, command.OverdueAmount, command.TransactionId, command.TransactionDate, command.IsBookingFee);
