...
namespace apcurium.MK.Booking.CommandHandlers
{
        ...
        ICommandHandler<AddUpdateAccountQuestionAnswer>
    {
        ...
        public void Handle(RegisterAccount command)
        {
            ...
            var account = new Account(command.AccountId, command.Name, command.CountryDialCode, command.Phone, command.Email, password,
        ...
        {
            var account = new Account(command.AccountId, command.Name, command.CountryDialCode, command.Phone, command.Email,
