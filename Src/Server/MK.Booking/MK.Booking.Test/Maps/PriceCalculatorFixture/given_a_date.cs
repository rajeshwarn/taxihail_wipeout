...
namespace apcurium.MK.Booking.Test.Maps.PriceCalculatorFixture
{
    ...
    public class given_a_day_tariff_ending_the_same_day
    {
        ...
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 17, 9, 0, 0), vehicleTypeId: 10);
        ...
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 17, 8, 0, 0), vehicleTypeId: 10);
        ...
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 17, 21, 0, 0), vehicleTypeId: 10);
        ...
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 17, 6, 0, 0), vehicleTypeId: 10);
    ...
    public class given_a_day_tariff_ending_the_next_day
    {
        ...
        public void when_date_doesnt_match_day()
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 3, 21, 0, 0), vehicleTypeId: 10);
        ...
        public void when_date_match_day_and_inside_time_period()
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 18, 21, 0, 0), vehicleTypeId: 10);
        ...
        public void when_date_match_day_and_start_time_exactly()
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 18, 20, 0, 0), vehicleTypeId: 10);
        ...
        public void when_date_match_day_but_before_start_time()
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 18, 19, 0, 0), vehicleTypeId: 10);
        ...
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 19, 8, 0, 0), vehicleTypeId: 10);
        ...
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 19, 1, 0, 0), vehicleTypeId: 10);
        ...
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 19, 21, 0, 0), vehicleTypeId: 10);
...
// ReSharper disable once InconsistentNaming
    public class given_a_recurring_tariff_ending_the_same_day
    {
        ...
        public void when_date_match_day_and_inside_time_period()
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 21, 9, 0, 0) /* Friday */, vehicleTypeId: 10);
        ...
        public void when_date_match_day_and_start_time_exactly()
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 21, 8, 0, 0), vehicleTypeId: 10);
    ...
    public class given_a_recurring_tariff_ending_the_next_day
    {
        ...
        public void when_date_match_day_and_inside_time_period()
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 21, 21, 0, 0), vehicleTypeId: 10);
        ...
        public void when_date_match_day_and_start_time_exactly()
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 21, 20, 0, 0), vehicleTypeId: 10);
        ...
        public void when_date_match_day_but_before_start_time()
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 21, 10, 0, 0), vehicleTypeId: 10);
        ...
        public void when_date_match_next_day_and_end_time_exactly()
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 22, 8, 0, 0), vehicleTypeId: 10);
        ...
        public void when_date_match_next_day_and_inside_time_period()
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 22, 7, 0, 0), vehicleTypeId: 10);
        ...
        public void when_date_match_next_day_but_after_end_time()
        {
            var tariff = _sut.GetTariffFor(new DateTime(2012, 12, 22, 12, 0, 0), vehicleTypeId: 10);
    ...
    public class given_a_defaultVehicle_tariff_ending_the_next_day
    {
        ...
        public void when_date_match_day_and_inside_time_period()
        {
            var tariff = _sut.GetTariffFor(new DateTime(1900, 1, 1, 23, 0, 0), vehicleTypeId: 10);
