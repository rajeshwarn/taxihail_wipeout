...
namespace apcurium.MK.Booking.Test.AccountFixture
{
    ...
    public class given_a_phone_number
    {
        ...
        public void Setup()
        {
            ...
            _sut.Setup(new SmsCommandHandler(new NotificationService(null, null, null, null, _serverSettings, null, _orderDaoMock.Object, null, new StaticMap(), _smsSenderMock.Object, null, null, null, null)));
        }
