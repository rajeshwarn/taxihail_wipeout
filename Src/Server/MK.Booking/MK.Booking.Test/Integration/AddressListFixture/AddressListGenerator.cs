...
// ReSharper disable once InconsistentNaming
    ...
    public class given_an_address : given_a_view_model_generator
    {
        ...
        {
            Sut.Handle(new FavoriteAddressUpdated
            {
                SourceId = _accountId,
                Address = new Address
                {
        ...
        {
            Sut.Handle(new DefaultFavoriteAddressRemoved
            {
                AddressId = _addressId
            });
        ...
        {
            Sut.Handle(new DefaultFavoriteAddressUpdated
            {
                Address = new Address
                {
                    Id = _addressId,
            ...
            using (var context = new BookingDbContext(DbName))
            {
                addressId =
                    context.Query<AddressDetails>()
                        .First(x => x.AccountId == orderCreated.AccountId && x.IsHistoric.Equals(true))
                        .Id;
            }
