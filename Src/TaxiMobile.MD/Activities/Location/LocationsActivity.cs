...
namespace TaxiMobile.Activities.Location
{
    ...
    public class LocationsActivity : Activity
    {
        ...
        private void SetAdapter()
        {
            ...
            Adapter.AddSection(Resources.GetString(Resource.String.FavoriteLocationsTitle), new SimpleAdapter(this, favoriteLocationsView, Resource.Layout.ListItem, new string[] { ITEM_TITLE }, new int[] { Resource.Id.ListComplexTitle }));
            Adapter.AddSection(Resources.GetString(Resource.String.LocationHistoryTitle), new SimpleAdapter(this, historyLocationsView, Resource.Layout.ListItem, new string[] { ITEM_TITLE }, new int[] { Resource.Id.ListComplexTitle }));
        }
        ...
        private void UpdateUI()
        {
            ...
            if (_parent != ParentScreens.BookScreen)
            {
                ...
                listView.ItemClick += new EventHandler<ItemEventArgs>(listView_ItemClickNormal);
            }
            else
            {
                CreateTemplate(listView);

                listView.ItemClick += new EventHandler<ItemEventArgs>(listView_ItemClickFromBook);
            }
        }
        ...
        private void listView_ItemClickNormal(object sender, ItemEventArgs e)
        {
        ...
        private void listView_ItemClickFromBook(object sender, ItemEventArgs e)
        {
            var item = Adapter.GetItem(e.Position) as IDictionary<string, object>;
            if ((item != null))
            {
